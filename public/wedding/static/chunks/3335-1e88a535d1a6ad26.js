    ...
    53335: function (e, r, o) {
      ...
      let t = (e) => {
          ...
          return {
            getClassGroupId: (e) => {
              let o = e.split("-");
              return (
                "" === o[0] && 1 !== o.length && o.shift(), a(o, r) || s(e)
              );
            },
      ...
      let x = (e) => {
        ...
        ed = (function (e, ...r) {
          ...
          let n = function (l) {
            return (
              (t = (o = f(r.reduce((e, r) => r(e), e()))).cache.get),
              (a = o.cache.set),
              (n = s),
              s(l)
            );
          ...
          let e = w("color"),
            ...
            eo = () => [e, Q, D],
            et = () => [...y(), V, J, { position: [Q, D] }],
            ea = () => [
              "no-repeat",
              { repeat: ["", "x", "y", "space", "round"] },
            ],
            en = () => ["auto", "cover", "contain", X, B, { size: [Q, D] }],
            es = () => [$, R, F],
            el = () => ["", "none", "full", d, Q, D],
            ei = () => ["", E, R, F],
          ...
          return {
            ...
            classGroups: {
              aspect: [{ aspect: ["auto", "square", P, D, Q, g] }],
              container: ["container"],
              columns: [{ columns: [E, D, Q, l] }],
              ...
              z: [{ z: [I, "auto", Q, D] }],
              basis: [{ basis: [P, "full", "auto", l, ...M()] }],
              "flex-direction": [
                { flex: ["row", "row-reverse", "col", "col-reverse"] },
              ],
              "flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }],
              flex: [{ flex: [E, P, "auto", "initial", "none", D] }],
              grow: [{ grow: ["", E, Q, D] }],
              shrink: [{ shrink: ["", E, Q, D] }],
              order: [{ order: [I, "first", "last", "none", Q, D] }],
              ...
              "font-size": [{ text: ["base", o, R, F] }],
              "font-smoothing": ["antialiased", "subpixel-antialiased"],
              "font-style": ["italic", "not-italic"],
              "font-weight": [{ font: [t, Q, H] }],
              "font-stretch": [
                {
                  "font-stretch": [
                    "ultra-condensed",
              ...
              tracking: [{ tracking: [a, Q, D] }],
              "line-clamp": [{ "line-clamp": [E, "none", Q, H] }],
              leading: [{ leading: [n, ...M()] }],
              "list-image": [{ "list-image": ["none", Q, D] }],
              "list-style-position": [{ list: ["inside", "outside"] }],
              "list-style-type": [{ list: ["disc", "decimal", "none", Q, D] }],
              "text-alignment": [
                {
              ...
              "underline-offset": [{ "underline-offset": [E, "auto", Q, D] }],
              "text-transform": [
                "uppercase",
                "lowercase",
                "capitalize",
              ...
              "outline-offset": [{ "outline-offset": [E, Q, D] }],
              "outline-w": [{ outline: ["", E, R, F] }],
              "outline-color": [{ outline: eo() }],
              shadow: [{ shadow: ["", "none", c, Z, L] }],
              "shadow-color": [{ shadow: eo() }],
              "inset-shadow": [{ "inset-shadow": ["none", m, Z, L] }],
              ...
              "text-shadow": [{ "text-shadow": ["none", p, Z, L] }],
              "text-shadow-color": [{ "text-shadow": eo() }],
              opacity: [{ opacity: [E, Q, D] }],
              "mix-blend": [
              ...
              "mask-image-radial": [{ "mask-radial": [Q, D] }],
              ...
              "mask-image": [{ mask: ["none", Q, D] }],
              filter: [{ filter: ["", "none", Q, D] }],
              blur: [{ blur: ep() }],
              brightness: [{ brightness: [E, Q, D] }],
              contrast: [{ contrast: [E, Q, D] }],
              "drop-shadow": [{ "drop-shadow": ["", "none", u, Z, L] }],
              "drop-shadow-color": [{ "drop-shadow": eo() }],
              grayscale: [{ grayscale: ["", E, Q, D] }],
              "hue-rotate": [{ "hue-rotate": [E, Q, D] }],
              invert: [{ invert: ["", E, Q, D] }],
              saturate: [{ saturate: [E, Q, D] }],
              sepia: [{ sepia: ["", E, Q, D] }],
              "backdrop-filter": [{ "backdrop-filter": ["", "none", Q, D] }],
              "backdrop-blur": [{ "backdrop-blur": ep() }],
              "backdrop-brightness": [{ "backdrop-brightness": [E, Q, D] }],
              "backdrop-contrast": [{ "backdrop-contrast": [E, Q, D] }],
              "backdrop-grayscale": [{ "backdrop-grayscale": ["", E, Q, D] }],
              "backdrop-hue-rotate": [{ "backdrop-hue-rotate": [E, Q, D] }],
              "backdrop-invert": [{ "backdrop-invert": ["", E, Q, D] }],
              "backdrop-opacity": [{ "backdrop-opacity": [E, Q, D] }],
              "backdrop-saturate": [{ "backdrop-saturate": [E, Q, D] }],
              "backdrop-sepia": [{ "backdrop-sepia": ["", E, Q, D] }],
              ...
              duration: [{ duration: [E, "initial", Q, D] }],
              ease: [{ ease: ["linear", "initial", h, Q, D] }],
              delay: [{ delay: [E, Q, D] }],
              animate: [{ animate: ["none", k, Q, D] }],
              backface: [{ backface: ["hidden", "visible"] }],
              perspective: [{ perspective: [f, Q, D] }],
              ...
              "skew-x": [{ "skew-x": ef() }],
              "skew-y": [{ "skew-y": ef() }],
              transform: [{ transform: [Q, D, "", "none", "gpu", "cpu"] }],

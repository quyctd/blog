			...
			function O(e) {
				...
				let I = (0, F.gu)(),
					M = async () => {
						...
						R(null), d(!0);
						try {
							await I.mutate({ nameUser: u, content: f, pageId: n }),
											...
											: /sinh nhật|birthday|chúc mừng sinh nhật/i.test(t)
												...
												: /tốt nghiệp|graduation|tốt nghiệp|ra trường/i.test(t)
													...
													: /sự kiện|event|kỷ niệm|anniversary/i.test(t)
														? "event"
														: /năm mới|new year|tết đến|tết mới|tất niên|tết/i.test(
																	t,
																)
															? "newyear"
															: "default";
					...
					? (0, a.jsxs)(a.Fragment, {
							children: [
								...
								(0, a.jsx)(j, {
									...
									children: (0, a.jsx)(O, {
										onClose: () => _(!J),
										pageId: null == p ? void 0 : p.page.identifier,
											...
											children: (0, a.jsxs)("span", {
												children: [
													...
													(0, a.jsx)("a", {
														...
														title: "Zenlove - Thiệp cưới online miễn ph\xed",
				...
				return (0, a.jsxs)(a.Fragment, {
					children: [
						(0, a.jsx)(ez, {
							...
							playing: l,
							audioIcon: s || "music-1",
							audioIconColor: o || "rgb(145, 143, 143)",
						}),
						(0, a.jsx)("audio", { src: x, ref: d, loop: !0, preload: "auto" }),
					],
				});
			});
			var eD = n(34577),
				...
				return (0, a.jsxs)(a.Fragment, {
					children: [
						(0, a.jsx)("h1", {
							className: "sr-only",
							children:
								"Thiệp cưới online miễn ph\xed - ".concat(
									null == h
										? void 0
							...
							children:
								(null == h
									...
									: null === (n = h.page) || void 0 === n
										? void 0
										: n.description) ||
								"Tạo v\xe0 gửi thiệp mời online nhanh ch\xf3ng với ZenLove",
						}),
						(0, a.jsxs)(eP, {
							dataPage: h,
							viewContext: u,
							...
							: e.thumbFile.size > 10485760
								...
								: e.dataFile.size > 52428800
									...
									: void 0 !== e.price && e.price < 0
										? {
												isValid: !1,
												error: "Gi\xe1 gift phải lớn hơn hoặc bằng 0",
											}

  ...
  [8110],
  {
    8110: function (e, t, a) {
      ...
      let d = r.forwardRef((e, t) =>
        r.createElement(s.Z, i({}, e, { ref: t, icon: o }))
      );
      var m = a(61994),
        h = a(87011),
        E = a(80052),
      ...
      let u = (e) => {
          ...
          return {
            [t]: {
              padding: ""
                .concat((0, k.bf)(e.calc(o).mul(2).equal()), " ")
                .concat((0, k.bf)(c)),
              "&-rtl": { direction: "rtl" },
            },
            ["".concat(t, " ").concat(t, "-image")]: {
              width: e.imageWidth,
            ...
            ["".concat(t, " ").concat(t, "-icon")]: {
              marginBottom: o,
              textAlign: "center",
              ["& > ".concat(r)]: { fontSize: e.iconFontSize },
            },
            ["".concat(t, " ").concat(t, "-title")]: {
            ...
            ["".concat(t, " ").concat(t, "-subtitle")]: {
              color: e.colorTextDescription,
              fontSize: e.subtitleFontSize,
              lineHeight: i,
              textAlign: "center",
            },
            ["".concat(t, " ").concat(t, "-body")]: {
              marginTop: o,
              padding: ""
                .concat((0, k.bf)(o), " ")
                .concat((0, k.bf)(e.calc(l).mul(2.5).equal())),
              backgroundColor: e.colorFillAlter,
            },
            ["".concat(t, " ").concat(t, "-extra")]: {
        ...
        f = (e) => {
          let { componentCls: t, iconCls: a } = e;
          return {
            ["".concat(t, "-success ").concat(t, "-icon > ").concat(a)]: {
              color: e.resultSuccessIconColor,
            },
            ["".concat(t, "-error ").concat(t, "-icon > ").concat(a)]: {
              color: e.resultErrorIconColor,
            },
            ["".concat(t, "-info ").concat(t, "-icon > ").concat(a)]: {
              color: e.resultInfoIconColor,
            },
            ["".concat(t, "-warning ").concat(t, "-icon > ").concat(a)]: {
      ...
      var B = (0, F.I$)(
        ...
        (e) => ({
          ...
          extraMargin: "".concat(e.paddingLG, "px 0 0 0"),
        })
      );
      let D = { success: l.Z, error: c.Z, info: n.Z, warning: d },
        A = {
          404: () =>
            r.createElement(
              "svg",
              { width: "252", height: "294" },
              r.createElement("title", null, "No Found"),
              r.createElement(
                "g",
          ...
          500: () =>
            r.createElement(
              ...
              r.createElement("title", null, "Server Error"),
              r.createElement(
                "g",
                { fill: "none", fillRule: "evenodd" },
                r.createElement("path", {
          ...
          403: () =>
            r.createElement(
              ...
              r.createElement("title", null, "Unauthorized"),
              r.createElement(
                "g",
                { fill: "none", fillRule: "evenodd" },
                r.createElement("path", {
        ...
        W = Object.keys(A),
        C = (e) => {
          let { icon: t, status: a, className: l, style: c } = e;
          if (W.includes("".concat(a))) {
            let e = A[a];
          ...
          let n = r.createElement(D[a]);
          return null === t || !1 === t
            ? null
            : r.createElement("div", { className: l, style: c }, t || n);
        },
        j = (e) => {
          let { className: t, extra: a, style: l } = e;
          return a
            ? r.createElement("div", { className: t, style: l }, a)
            : null;
        },
        g = (e) => {
          let {
            ...
            I = (0, m.W)("".concat(H, "-title"), b.title),
            w = (0, m.W)("".concat(H, "-subtitle"), b.subTitle),
            _ = (0, m.W)("".concat(H, "-extra"), b.extra),
            V = (0, m.W)("".concat(H, "-body"), b.body),
            R = (0, m.W)(
              "".concat(H, "-icon"),
              { ["".concat(H, "-image")]: W.includes("".concat(i)) },
              b.icon
            ),
            T = { ...y.root, ...D, ...o },
            Z = (0, h.Z)(u, { aria: !0, data: !0 });
          return r.createElement(
            "div",
            { ...Z, className: N, style: T },
            r.createElement(C, {
              className: R,
              style: y.icon,
              status: i,
            ...
            r.createElement("div", { className: I, style: y.title }, n),
            c && r.createElement("div", { className: w, style: y.subTitle }, c),
            r.createElement(j, { className: _, extra: k, style: y.extra }),
            s && r.createElement("div", { className: V, style: y.body }, s)
          );
        };
      (g.PRESENTED_IMAGE_403 = A["403"]),
        (g.PRESENTED_IMAGE_404 = A["404"]),
        (g.PRESENTED_IMAGE_500 = A["500"]);
      var z = g;
    },
  },
]);
